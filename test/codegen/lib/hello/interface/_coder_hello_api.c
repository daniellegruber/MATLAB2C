...
static real_T emlrt_marshallIn(const emlrtStack *sp, const mxArray *num,
...
void hello_api(const mxArray *prhs)
{
  ...
  num = emlrt_marshallIn(&st, emlrtAliasP(prhs), "num");
...
/* End of code generation (_coder_hello_api.c) */

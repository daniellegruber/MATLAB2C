...
static emlrtRSInfo emlrtRSI =
    {
        13,      /* lineNo */
        "sobel", /* fcnName */
        "C:\\Users\\danie\\OneDrive\\Documents\\MATLAB\\MATLAB2C\\sobel\\sobel."
        "m" /* pathName */
};
...
static emlrtRSInfo d_emlrtRSI = {
    ...
    "conv2", /* fcnName */
    "C:\\Program "
    "Files\\MATLAB\\R2022a\\toolbox\\eml\\lib\\matlab\\datafun\\conv2.m" /* pathName
                                                                          */
};
...
static emlrtRSInfo f_emlrtRSI = {
    ...
    "conv2", /* fcnName */
    "C:\\Program "
    "Files\\MATLAB\\R2022a\\toolbox\\eml\\eml\\+coder\\+internal\\conv2.m" /* pathName
                                                                            */
};
           ...
           real_T threshold, emxArray_uint8_T *edgeImage)
{
  ...
  e_st.tls = d_st.tls;
  emlrtHeapReferenceStackEnterFcnR2012b((emlrtCTX)sp);
  emxInit_real_T(sp, &H, &c_emlrtRTEI);
  emxInit_real_T(sp, &V, &d_emlrtRTEI);
  ...
  nx = H->size[0] * H->size[1];
  for (i = 0; i < nx; i++) {
    edgeImage_data[i] = (uint8_T)((H_data[i] > threshold) * 255U);
  }
  emxFree_real_T(sp, &H);
  emlrtHeapReferenceStackLeaveFcnR2012b((emlrtCTX)sp);
}
